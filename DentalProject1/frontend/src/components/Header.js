...
function Header() {
  ...
  return (
    <div>
      <header class=" fixed bg-blue-teal-gradient top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
            ...
            <ul class="flex text-white">
              <li>
                <div class="flex items-center">
                  ...
                  <span class="ml-2">178 Phase-8, MOHALI, PUNJAB, INDIA</span>
                </div>
              </li>
              <li class="ml-6">
                <div class="flex items-center">
                  ...
                  <span class="ml-2">+91 862-7867-193</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="flex flex-wrap items-center justify-between py-6">
          <div class="w-1/2 md:w-auto">
            <Link to="/" class="text-white font-bold text-5xl">
              DentalPro
            </Link>
          </div>
          ...
          <div class="hidden md:block w-full md:w-auto" id="menu">
            <nav
              ...
              <ul class="md:flex items-center">
                <li><Link class="py-2 inline-block md:text-white md:hidden lg:block font-semibold" to="/about-us">About Us</Link></li>
                <li class="md:ml-4"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold"
                  to="/treatments">Treatments</Link></li>
                {dataaaa?.isAdmin !== 1 ? <>
                  <li class="md:ml-4"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold" to="/contact-us">Contact
                    Us</Link></li>
                  {/* {dataaaa?.isAdmin === 0 ? "" : <li class="md:ml-4"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold" to="/signup">Sign up</Link></li>} */}
                  {dataaaa?.role === 0 ?
                    <li class="md:ml-6 mt-3 md:mt-0">
                      <Link class="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded"
                        to="/book-appoinment">Book
                        Appointment</Link>
                    </li> : ""}
                  {dataaaa?.role === 1 ?
                    <li class="md:ml-6 mt-3 md:mt-0">
                      <Link class="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded"
                        to="/AppointmentTable">User
                        Appointments</Link>
                    </li> : ""}
                  {dataaaa?.role === 0 ?
                    <li class="md:ml-6 mt-3 md:mt-0">
                      <Link class="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded"
                        to="/ViewAppointment">View
                        Appointments</Link>
                    </li> : ""}
                ...
                {dataaaa?.role === 2 ?
                  <li class="md:ml-6 mt-3 md:mt-0">
                    <Link class="py-2 inline-block md:text-white md:px-2 font-semibold"
                ...
                {dataaaa ?
                  (<li class="md:ml-4 md:hidden lg:block"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold"
                    to="login" onClick={handleLogout}>Logout</Link></li>)
                  :
                  (<li class="md:ml-4 md:hidden lg:block"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold"
                    to="login">Login</Link>
                  </li>)}
